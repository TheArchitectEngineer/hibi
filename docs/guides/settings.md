...
The dropdown beside the sidebar button lists available views. Use its first item to pin or unpin a titlebar shortcut for the current view; you can pin up to three. **On this page** shows the document's headings and highlights your current section. See [workspaces](workspaces.md) for navigation and resizing.
