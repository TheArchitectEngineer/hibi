...
The graph fits the available space when opened or filtered. Click a dot to open its note. Drag the background to move around, scroll to zoom, or choose **Expand** to open a larger graph in a tab. **Fit graph** returns to the overview. Zoom in or filter a dense graph to see note labels.
